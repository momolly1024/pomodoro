...
<div>
  <b-tabs content-class="mt-3">
    ...
    <b-tab title="個人化">
      ...
      <th>個人化設定</th>
      <tr >
      <td > 勵志標語：<b-form-input type="text" class="sayinput w-50 align-middle" v-model="Newthing"  maxlength="20"></b-form-input> <b-button size="sm" style="color:green;background:white" @click="savesaysomthing(Newthing)"> <font-awesome-icon :icon="['fas', 'save']"></font-awesome-icon></b-button></td>
